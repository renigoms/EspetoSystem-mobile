...
import 'package:espetosystem/app/UI/client/routes/routes.dart';
...
final routes = GoRouter(
  initialLocation: '/',
  refreshListenable:
      null, // Será configurado via builder se necessário, ou deixamos estático se o provider não for acessível aqui.
  ...
  routes: [...authRoutes, ...homeRoutes, ...clientRoutes],
);
